...
Neither requires you to create or activate a venv. Recommended: FarmNotary
**1.0.0** or later. The command itself is available from **0.2.0** onward,
but 1.0.0 is the recommended secure release.
