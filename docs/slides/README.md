...
| Deck | HTML | PDF | For |
|---|---|---|---|
| Intro | [`index.html`](index.html) | Chrome print | Researchers and labs: what a notary is, what it will not claim |
...
Regenerate the walkthrough PDF with Chrome or Chromium:
